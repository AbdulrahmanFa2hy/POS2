...
const OrderDetails = ({
  ...
  // Calculate real subtotal, discount, and total
  ...
  return (
    <div className="flex flex-col h-[92vh] relative">
      ...
      <div className="flex flex-col lg:flex-row justify-between mb-8">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-full">
          <span className="text-sm font-medium text-gray-600">
            {selectedOrder.type === "takeaway" ? "Type:" : "Table:"}
          </span>
      ...
      <div className="flex justify-between items-center flex-wrap gap-2 border-t border-gray-200 pt-2 mt-2 mb-4">
        ...
        <div>
          <input
            ...
            className=" w-28 py-1  px-2 text-sm border border-gray-200 rounded focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
            min="0"
            step="1"
          />
        </div>
