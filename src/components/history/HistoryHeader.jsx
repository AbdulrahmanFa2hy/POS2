      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative" ref={calendarRef}>
          ...
          >
            ...
            <RiArrowDownSLine className={`text-neutral-500 transition-transform duration-200 ${isCalendarOpen ? 'rotate-180' : ''}`} />
          </button>
          
          {isCalendarOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-neutral-200 z-10 animate-fade-in">
              <div className="p-3">
                <p className="text-sm font-medium text-neutral-500 mb-2">Select Date</p>
